...
- Ranks suggestions with Raw power, General-purpose, or Robust posture. General-purpose and Robust use transparent role breadth and balance heuristics; they do not simulate a specific opponent.
...
The posture lens groups units into frontline, ranged, and mobile roles. It rewards coverage and, for Robust posture, more balanced shares across those roles. It is a visible heuristic for an unknown opponent, not a hidden counter model.
